	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6 col-xs-6 text-right">
				...
				<a href="{{url('index/')}}" class="login-button">LOGIN</a><a href="{{url('register/')}}" class="signup-button">SIGN UP</a>
			</div>
		</div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4" id="login_form">
                <form class="form-signin" role="form" method="post" action="{{url('login/')}}" id="login_form_child">
