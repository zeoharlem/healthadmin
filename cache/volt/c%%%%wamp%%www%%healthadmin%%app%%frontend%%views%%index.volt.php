        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="assets/img/logo.png" data-dark-src="<?= $this->url->get('assets/main/img/logo_dark.png') ?>" class="logo">
                </a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4" id="login_form">
                ...
                Need an account? <a href="<?= $this->url->get('register/') ?>">Sign up</a> now!
              </form>
            </div>
        </div>
      </div>	</div>
